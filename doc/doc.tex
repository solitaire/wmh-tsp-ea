...
\subsection{Struktury danych}
	...
	\paragraph{Populacja}
		Populacja jest reprezentowana jako tablica rozwiązań. Rozmiar populacji jest stały i równy $10*D$.
...
$
	...
	Warunkiem zatrzymania algorytmu jest wykonanie $E$ ewaluacji. Liczba ewaluacji algorytmu ewolucyjnego jest określona następująco: $E = 100000 * D$, gdzie $D$ to rozmiar problemu (liczba miast).
	...
	Złożoność operatorów genetycznych: mutacji oraz krzyżowania jest równa $O(n)$, gdzie $n = D$ to rozmiar rozwiązania (liczba miast).
