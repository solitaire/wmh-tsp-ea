...
\begin{description}
	\item[Wejście] \hfill \\
Wejściem dla algorytmu %TODO opisać jaki format przyjmuje aplikacja
	\item[Wyjście] \hfill \\
...
%TODO tu opisać, że na tych grafach testowaliśmy dobór odpwiednich parametrów,
% jescze przed testowaniem na rzeczywistych danych z osm
...
%TODO tu opisać testy na danych z osm, losowe miasta itd
